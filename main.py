...
while(True):
    ...
    lower_hsv =numpy.array([lower_value,lower_saturation,lower_value])
    ...
    bedshit_area=cv2.merge((b,g,r))


    final = cv2.bitwise_or(frame_inv,bedshit_area)
    cv2.imshow("HarryPotter Cloak" ,final)
